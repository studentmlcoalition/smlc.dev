  ...
  return (
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-40 pb-10 md:pt-48 md:pb-16">
          {/* Hero content */}
          <div className="md:grid md:grid-cols-12 md:gap-12 lg:gap-20 items-center">
            {/* Content */}
            <div className="md:col-span-7 lg:col-span-6 mb-8 md:mb-0 text-center md:text-left">
              <h1
                className="h1 lg:text-6xl mb-10 font-red-hat-display font-extrabold"
                data-aos="fade-down"
              >
              ...
              <p
                ...
                data-aos-delay="150"
              >
                Welcome to SMLC! Our mission is to help anyone get involved in
                machine learning through online courses, library classes, and
                collaboration.
              </p>
            </div>
            ...
            <div className="md:col-span-6 lg:col-span-6 md:text-right">
              <img
                src={require("../images/home-circle-top.png").default}
                alt="Course Front Page"
              />
            </div>
